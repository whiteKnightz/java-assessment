...
public class TenMinWalk {
    ...
    public static void main(String[] args) {
        System.out.println("Is valid for: {'n','s','n','s','n','s','n','s','n','s'}:"+
                isValid(new char[] {'n','s','n','s','n','s','n','s','n','s'}));;
        System.out.println("Is valid for: {'w','e','w','e','w','e','w','e','w','e','w','e'}:"+
                isValid(new char[] {'w','e','w','e','w','e','w','e','w','e','w','e'}));;
        System.out.println("Is valid for: {'w'}:"+isValid(new char[] {'w'}));;
        System.out.println("Is valid for: {'n','n','n','s','n','s','n','s','n','s'}:"+
